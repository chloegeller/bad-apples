...
var SliderTrial = function() {
	...
	var out_act_inst = {
		...
		pages: [
			`<div style="width:500px;"><p> Think of an <b>outdoor activity</b> that you consider to be a 9/10.</p><p><p>Once you have thought of one, please press next.<p></div>`,`<div style="width:500px;"><div style="text-align: center;">There's a new <strong>outdoor activity</strong> called "<i><b>Bliggintom</b></i>", and your friends consider it to be a 3/10.</div></div>`, `<div style="width:500px;"><p>How would you like to split the next <b>12 hours</b> between the two activities?</p></div>`],
	...
	timeline.push(out_act_inst, out_act, in_act, sport, book, show, movie, fruit, dish, beverage, board_game, video_game, lawn_game);

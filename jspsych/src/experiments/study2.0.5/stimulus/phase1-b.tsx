      ...
      return <form onSubmit={handleSubmit}>
        <Card klass="stimulus">
          ...
          <Card.Body klass="stimulus-body">
            ...
            {/*<Field name={"sub_cat"} type={"hidden"} component={"input"} value={sub_cat} readOnly/>*/}
            <InputItem name="participant_item" validate={composeValidators(required)}
                       placeholder={`Please provide a familiar ${subcategory}`}/>
            
            {/*<InputItem name={"sub_cat"} type={"hidden"} validate={composeValidators(required)} value={sub_cat} readOnly/>*/}
          </Card.Body>
          <Card.Footer>
